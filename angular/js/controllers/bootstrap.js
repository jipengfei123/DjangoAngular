...
app.controller('ButtonsDemoCtrl', ['$scope', function ($scope) {
    ...
    $('[ng-repeat="user in users"]').each(function (e) {
        var name = $(this).find(" div > div.listRowColumn.listRowColumnUserName > div").html();
        var nameEl = $(this).find(" div > div:nth-child(3) > div > input");
        // var pwdEl = $(this).find(" div > div:nth-child(3) > div > input");
        name = name.trim();
